...
class AccountMove(models.Model):
    ...
    #                 MOVE_TAX_USER_TYPE[self.move_type]
    #             )
    #
    #             if deductible_tax:
    ...
    # TODO Replaced by _compute_invoice_taxes_by_group
    ...
    def action_post(self):
        ...
        # for record in self.filtered(lambda i: i.credit_move_id):
        ...
        #             if line.account_id.id == record.credit_move_id.account_id.id:
        #                 to_reconcile_lines += line
        #
