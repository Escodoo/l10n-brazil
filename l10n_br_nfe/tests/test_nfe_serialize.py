...
class TestNFeExport(TransactionCase):
    ...
    def test_serialize_xml(self):
        ...
        self.nfe.date_in_out = datetime.strptime(
            '2020-06-04T11:58:46', '%Y-%m-%dT%H:%M:%S')
        self.nfe.with_context(lang='pt_BR').key = \
            'NFe35200781583054000129550010000000011062777160'
        self.nfe.with_context(lang='pt_BR').nfe40_cNF = '06277716'
        self.nfe.with_context(lang='pt_BR').nfe40_cDV = '0'
