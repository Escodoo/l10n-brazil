...
class Document(models.Model):
    ...
    def _prepare_dados_servico(self):
        ...
        for line in lines:
            ...
            base_calculo += result_line.get('issqn_base') or result_line.get('issqn_wh_base') or 0
            valor_liquido_nfse += result_line.get('valor_liquido_nfse')
            valor_desconto_incondicionado += result_line.get('valor_desconto_incondicionado')
        ...
        result = {
            ...
            "aliquota": (self.fiscal_line_ids[0].issqn_percent / 100) or (self.fiscal_line_ids[0].issqn_wh_percent / 100),
            ...
            "codigo_tributacao_municipio": self.fiscal_line_ids[0].city_taxation_code_id.code or "",
            "municipio_prestacao_servico": self.fiscal_line_ids[0].issqn_fg_city_id.ibge_code or "",
            "discriminacao": str(self.fiscal_line_ids[0].name[:2000] or ""),
            "codigo_cnae": misc.punctuation_rm(self.fiscal_line_ids[0].cnae_id.code) or None,
