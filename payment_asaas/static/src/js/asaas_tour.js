...
odoo.define("payment_asaas.tour", function (require) {
    "use strict";
    ...
    tour.register(
        ...
        [
            ...
            },
            {
                ...
                trigger: '#payment_method label:contains("Asaas")',
            },
            {
            ...
            },
            {
                content: "pay now",
                extra_trigger:
                    '#payment_method label:contains("Asaas") input:checked,#payment_method:not(:has("input:radio:visible"))',
